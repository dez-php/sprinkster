...
class Memcached extends \Core\Cache\Backend implements \Core\Cache\Backend\ExtendedInterface {
	/**
	 * Default Values
	 */
	 ...
	 * Log message
	 */
	const TAGS_UNSUPPORTED_BY_CLEAN_OF_MEMCACHED_BACKEND = '\Core\Cache\Backend\Memcached::clean() : tags are unsupported by the Memcached backend';
	const TAGS_UNSUPPORTED_BY_SAVE_OF_MEMCACHED_BACKEND = '\Core\Cache\Backend\Memcached::save() : tags are unsupported by the Memcached backend';
	...
	public function __construct(array $options = array()) {
		if (! extension_loaded ( 'memcache' )) {
			\Core\Cache\Base::throwException ( 'The memcache extension must be loaded for using this backend !' );
		}
	...
	public function clean($mode = \Core\Cache\Base::CLEANING_MODE_ALL, $tags = array()) {
		switch ($mode) {
			...
			case \Core\Cache\Base::CLEANING_MODE_OLD :
				// $this->_log("\\Core\\Cache\\Backend\\Memcached::clean() :
	...
	public function getIds() {
		// $this->_log("\Core\Cache\Backend\Memcached::save() : getting the list
		// of cache ids is unsupported by the Memcache backend");
		return array ();
	}
