...
abstract class AbstractDataProvider extends \Core\Component implements \Core\Interfaces\DataProvider {
	...
	*/
	 ...
	 * @return \Core\DataProvider\Pagination|false the pagination object. If this is false, it means the pagination is disabled.
	 */
	public function getPagination($className='\Core\DataProvider\Pagination')
	{
	 ...
	 * @param mixed $value the pagination to be used by this data provider. This could be a {@link \Core\DataProvider\Pagination} object
