 ...
 * @since 1.1
 */
class ActiveDataProvider extends AbstractDataProvider
{
	/**
	...
	public function __construct($modelClass,$config=array())
	{
		...
		elseif($modelClass instanceof \Core\Db\ActiveRecord)
		{
			$this->modelClass=get_class($modelClass);
			$this->model=$modelClass;
		}
		$this->setId(\Core\Html::modelName($this->model));
	...
	public function getCriteria()
	{
		if($this->_criteria===null)
			$this->_criteria=new \Core\Db\Schema\Criteria;
	...
	{
		$this->_criteria=$value instanceof \Core\Db\Schema\Criteria ? $value : new \Core\Db\Schema\Criteria($value);
	}
	...
	{
		$this->_countCriteria=$value instanceof \Core\Db\Schema\Criteria ? $value : new \Core\Db\Schema\Criteria($value);
	}
	 ...
	 */
	public function getSort($className='\Core\DataProvider\Sort')
	{
	...
	{
		return \Core\Db\ActiveRecord::model($className);
	}
