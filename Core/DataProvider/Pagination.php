 ...
 *
 * When data needs to be rendered in multiple pages, we can use \Core\DataProvider\Pagination to
 ...
 *     $pages=new \Core\DataProvider\Pagination($count);
 *
 *     // results per page
 *     $pages->pageSize=10;
 ...
 *
 * // display pagination
 * <?php $this->widget('\Core\Fmx\Widgets\Pager\Link', array(
 *     'pages' => $pages,
 * )) ?>
 * </pre>
 *
 ...
 * @since 1.0
 */
class Pagination extends \Core\Component
{
	/**
	...
	public function createPageUrl($controller,$page)
	{
		...
		return \Core\Base\Action::getComponent('uri')->createUrl($this->route,$params);
	}
