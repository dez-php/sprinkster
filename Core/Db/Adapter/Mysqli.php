...
class Mysqli extends \Core\Db\Adapter\AbstractAdapter {
	 ...
	 * @var string
	 */
	protected $_defaultStmtClass = '\Core\Db\Statement\Mysqli';
	...
	public function listTables() {
		...
		if ($queryResult = $this->getConnection ()->query ( $sql )) {
			...
			/**
			 *
			 * @see \Core\Db\Adapter\Mysqli\Exception
			 */
			require_once 'Db/Adapter/Mysqli/Exception.php';
			throw new \Core\Db\Adapter\Mysqli\Exception ( $this->getConnection ()->error );
		}
		return $result;
	}
	 ...
	 *
	 * @return void
	 * @throws \Core\Db\Adapter\Mysqli\Exception
	 */
	protected function _connect() {
		...
		if (! extension_loaded ( 'mysqli' )) {
			 ...
			 */
			require_once 'Db/Adapter/Mysqli/Exception.php';
			throw new \Core\Db\Adapter\Mysqli\Exception ( 'The Mysqli extension is required for this adapter but the extension is not loaded' );
		}
		...
		if ($_isConnected === false || mysqli_connect_errno ()) {
			 ...
			 */
			require_once 'Db/Adapter/Mysqli/Exception.php';
			throw new \Core\Db\Adapter\Mysqli\Exception ( mysqli_connect_error () );
		}
	 ...
	 * @param string $sql
	 *        	SQL query
	 * @return \Core\Db\Statement\Mysqli
	 */
	...
	public function setFetchMode($mode) {
		switch ($mode) {
			case \Core\Db\Init::FETCH_LAZY :
			case \Core\Db\Init::FETCH_ASSOC :
			case \Core\Db\Init::FETCH_NUM :
			case \Core\Db\Init::FETCH_BOTH :
			case \Core\Db\Init::FETCH_NAMED :
			case \Core\Db\Init::FETCH_OBJ :
			...
			case \Core\Db\Init::FETCH_BOUND : // bound to PHP variable
				 ...
				 */
				require_once 'Db/Adapter/Mysqli/Exception.php';
				throw new \Core\Db\Adapter\Mysqli\Exception ( 'FETCH_BOUND is not supported yet' );
				break;
			default :
				/**
				 *
				 ...
				 */
				require_once 'Db/Adapter/Mysqli/Exception.php';
				throw new \Core\Db\Adapter\Mysqli\Exception ( "Invalid fetch mode '$mode' specified" );
		}
	}
	...
	public function limit($sql, $count, $offset = 0) {
		...
		if ($count <= 0) {
			 ...
			 */
			require_once 'Db/Adapter/Mysqli/Exception.php';
			throw new \Core\Db\Adapter\Mysqli\Exception ( "LIMIT argument count=$count is not valid" );
		}
		...
		if ($offset < 0) {
			 ...
			 */
			require_once 'Db/Adapter/Mysqli/Exception.php';
			throw new \Core\Db\Adapter\Mysqli\Exception ( "LIMIT argument offset=$offset is not valid" );
		}
