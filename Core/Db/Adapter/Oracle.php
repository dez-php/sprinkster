...
class Oracle extends \Core\Db\Adapter\AbstractAdapter {
	/**
	...
	protected $_numericDataTypes = array (
			...
			'BINARY_DOUBLE' => \Core\Db\Init::FLOAT_TYPE,
			'BINARY_FLOAT' => \Core\Db\Init::FLOAT_TYPE,
			'NUMBER' => \Core\Db\Init::FLOAT_TYPE 
	);
	 ...
	 * @var string
	 */
	protected $_defaultStmtClass = '\Core\Db\Statement\Oracle';
	 ...
	 *
	 * @return void
	 * @throws \Core\Db\Adapter\Oracle\Exception
	 */
	protected function _connect() {
		...
		if (! extension_loaded ( 'oci8' )) {
			/**
			 *
			 * @see \Core\Db\Adapter\Oracle\Exception
			 */
			require_once 'Db/Adapter/Oracle/Exception.php';
			throw new \Core\Db\Adapter\Oracle\Exception ( 'The OCI8 extension is required for this adapter but the extension is not loaded' );
		}
		...
		if (! $this->_connection) {
			 ...
			 */
			require_once 'Db/Adapter/Oracle/Exception.php';
			throw new \Core\Db\Adapter\Oracle\Exception ( oci_error () );
		}
	}
	 ...
	 * @return \Core\Db\Statement\Oracle
	 */
	public function prepare($sql) {
		...
		if ($stmt instanceof \Core\Db\Statement\Oracle) {
	 ...
	 *
	 * @param string|array|\Core\Db\Expr $ident
	...
	protected function _commit() {
		if (! oci_commit ( $this->_connection )) {
			 ...
			 */
			require_once 'Db/Adapter/Oracle/Exception.php';
			throw new \Core\Db\Adapter\Oracle\Exception ( oci_error ( $this->_connection ) );
		}
		$this->_setExecuteMode ( OCI_COMMIT_ON_SUCCESS );
	}
	...
	public function setFetchMode($mode) {
		switch ($mode) {
			...
			case \Core\Db\Init::FETCH_BOUND : // bound to PHP variable
				 ...
				 */
				require_once 'Db/Adapter/Oracle/Exception.php';
				throw new \Core\Db\Adapter\Oracle\Exception ( 'FETCH_BOUND is not supported yet' );
				break;
			default :
				/**
				 *
				 ...
				 */
				require_once 'Db/Adapter/Oracle/Exception.php';
				throw new \Core\Db\Adapter\Oracle\Exception ( "Invalid fetch mode '$mode' specified" );
				break;
		}
	}
	...
	public function limit($sql, $count, $offset = 0) {
		...
		if ($count <= 0) {
			 ...
			 */
			require_once 'Db/Adapter/Oracle/Exception.php';
			throw new \Core\Db\Adapter\Oracle\Exception ( "LIMIT argument count=$count is not valid" );
		}
		...
		if ($offset < 0) {
			 ...
			 */
			require_once 'Db/Adapter/Oracle/Exception.php';
			throw new \Core\Db\Adapter\Oracle\Exception ( "LIMIT argument offset=$offset is not valid" );
		}
	...
	private function _setExecuteMode($mode) {
		switch ($mode) {
			...
			default :
				 ...
				 */
				require_once 'Db/Adapter/Oracle/Exception.php';
				throw new \Core\Db\Adapter\Oracle\Exception ( "Invalid execution mode '$mode' specified" );
				break;
		}
	}
