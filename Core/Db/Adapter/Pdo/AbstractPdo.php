...
abstract class AbstractPdo extends \Core\Db\Adapter\AbstractAdapter {
	 ...
	 * @var string
	 */
	protected $_defaultStmtClass = '\Core\Db\Statement\Pdo';
	...
	protected function _connect() {
		...
		if (! extension_loaded ( 'pdo' )) {
			...
			throw new \Core\Db\Adapter\Exception ( 'The PDO extension is required for this adapter but the extension is not loaded' );
		}
		...
		if (! in_array ( $this->_pdoType, \PDO::getAvailableDrivers () )) {
			 ...
			 */
			require_once 'Db/Adapter/Exception.php';
			throw new \Core\Db\Adapter\Exception ( 'The ' . $this->_pdoType . ' driver is not currently installed' );
		}
		
		// create PDO connection
		$q = $this->_profiler->queryStart ( 'connect', \Core\Db\Profiler::CONNECT );
	 ...
	 * @param array $bind
	 *        	An array of data to bind to the placeholders.
	 * @return \Core\Db\Statement\Pdo
	 * @throws \Core\Db\Adapter\Exception To re-throw PDOException.
	 */
	public function query($sql, $bind = array()) {
		if (empty ( $bind ) && $sql instanceof \Core\Db\Select) {
			$bind = $sql->getBind ();
		}
	...
	public function exec($sql) {
		...
		try {
			...
			if ($affected === false) {
				 ...
				 */
				require_once 'Db/Adapter/Exception.php';
				throw new \Core\Db\Adapter\Exception ( $errorInfo [2] );
			}
	...
	public function setFetchMode($mode) {
		...
		switch ($mode) {
			...
			default :
				 ...
				 */
				require_once 'Db/Adapter/Exception.php';
				throw new \Core\Db\Adapter\Exception ( "Invalid fetch mode '$mode' specified" );
				break;
		}
	}
