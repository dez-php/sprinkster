...
class Db2 extends \Core\Db\Statement {
	 ...
	 * @param string $sql        	
	 * @return void
	 * @throws \Core\Db\Statement\Db2\Exception
	 */
	public function _prepare($sql) {
		...
		if (! $this->_stmt) {
			/**
			 *
			 * @see \Core\Db\Statement\Db2\Exception
			 */
			require_once 'Db/Statement/Db2/Exception.php';
			throw new \Core\Db\Statement\Db2\Exception ( db2_stmt_errormsg (), db2_stmt_error () );
		}
	}
	...
	public function fetch($style = null, $cursor = null, $offset = null) {
		...
		switch ($style) {
			...
			default :
				 ...
				 */
				require_once 'Db/Statement/Db2/Exception.php';
				throw new \Core\Db\Statement\Db2\Exception ( "Invalid fetch mode '$style' specified" );
				break;
		}
	...
	public function fetchObject($class = 'stdClass', array $config = array()) {
		$obj = $this->fetch ( \Core\Db\Init::FETCH_OBJ );
		return $obj;
	}
	...
	public function nextRowset() {
		 ...
		 */
		require_once 'Db/Statement/Db2/Exception.php';
		throw new \Core\Db\Statement\Db2\Exception ( __FUNCTION__ . '() is not implemented' );
	}
