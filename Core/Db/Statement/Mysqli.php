...
class Mysqli extends \Core\Db\Statement {
	 ...
	 * @param string $sql        	
	 * @return void
	 * @throws \Core\Db\Statement\Mysqli\Exception
	 */
	public function _prepare($sql) {
		...
		if ($this->_stmt === false || $mysqli->errno) {
			/**
			 *
			 * @see \Core\Db\Statement\Mysqli\Exception
			 */
			require_once 'Db/Statement/Mysqli/Exception.php';

			throw new \Core\Db\Statement\Mysqli\Exception ( "Mysqli prepare error: " . $mysqli->error, $mysqli->errno );
		}
	}
	...
	public function _execute(array $params = null) {
		...
		if ($retval === false) {
			 ...
			 */
			require_once 'Db/Statement/Mysqli/Exception.php';
			throw new \Core\Db\Statement\Mysqli\Exception ( "Mysqli statement execute error : " . $this->_stmt->error, $this->_stmt->errno );
		}
		...
		if ($this->_meta === null) {
			...
			if ($this->_stmt->errno) {
				 ...
				 */
				require_once 'Db/Statement/Mysqli/Exception.php';
				throw new \Core\Db\Statement\Mysqli\Exception ( "Mysqli statement metadata error: " . $this->_stmt->error, $this->_stmt->errno );
			}
		}
	...
	public function fetch($style = null, $cursor = null, $offset = null) {
		...
		switch ($style) {
			...
			default :
				 ...
				 */
				require_once 'Db/Statement/Mysqli/Exception.php';
				throw new \Core\Db\Statement\Mysqli\Exception ( "Invalid fetch mode '$style' specified" );
				break;
		}
		return $row;
	}
	...
	public function nextRowset() {
		 ...
		 */
		require_once 'Db/Statement/Mysqli/Exception.php';
		throw new \Core\Db\Statement\Mysqli\Exception ( __FUNCTION__ . '() is not implemented' );
	}
