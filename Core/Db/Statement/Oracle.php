...
class Oracle extends \Core\Db\Statement {
	 ...
	 * @param string $sql        	
	 * @return void
	 * @throws \Core\Db\Statement\Oracle\Exception
	 */
	protected function _prepare($sql) {
		...
		if (! $this->_stmt) {
			/**
			 *
			 * @see \Core\Db\Statement\Oracle\Exception
			 */
			require_once 'Db/Statement/Oracle/Exception.php';
			throw new \Core\Db\Statement\Oracle\Exception ( oci_error ( $connection ) );
		}
	}
	...
	protected function _bindParam($parameter, &$variable, $type = null, $length = null, $options = null) {
		...
		if ($retval === false) {
			 ...
			 */
			require_once 'Db/Statement/Oracle/Exception.php';
			throw new \Core\Db\Statement\Oracle\Exception ( oci_error ( $this->_stmt ) );
		}
	...
	public function fetch($style = null, $cursor = null, $offset = null) {
		...
		switch ($style) {
			...
			default :
				 ...
				 */
				require_once 'Db/Statement/Oracle/Exception.php';
				throw new \Core\Db\Statement\Oracle\Exception ( array (
						'code' => 'HYC00',
		...
		if (! $row && $error = oci_error ( $this->_stmt )) {
			 ...
			 */
			require_once 'Db/Statement/Oracle/Exception.php';
			throw new \Core\Db\Statement\Oracle\Exception ( $error );
		}
	...
	public function fetchAll($style = null, $col = 0) {
		...
		switch ($style) {
			...
			case \Core\Db\Init::FETCH_OBJ :
				break;
			case \Core\Db\Init::FETCH_COLUMN :
		...
		if ($flags != OCI_FETCHSTATEMENT_BY_ROW) { /*
			...
			if ($style == \Core\Db\Init::FETCH_COLUMN) {
				$result = $result [$col];
			}
