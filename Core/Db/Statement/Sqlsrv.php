...
class Sqlsrv extends \Core\Db\Statement {
	 ...
	 * @param string $sql        	
	 * @return void
	 * @throws \Core\Db\Statement\Sqlsrv\Exception
	 */
	protected function _prepare($sql) {
		...
		if (! $this->_stmt) {
			require_once 'Db/Statement/Sqlsrv/Exception.php';
			throw new \Core\Db\Statement\Sqlsrv\Exception ( sqlsrv_errors () );
		}
	...
	public function fetch($style = null, $cursor = null, $offset = null) {
		...
		if (! $values && (null !== $error = sqlsrv_errors ())) {
			require_once 'Db/Statement/Sqlsrv/Exception.php';
			throw new \Core\Db\Statement\Sqlsrv\Exception ( $error );
		}
		...
		switch ($style) {
			...
			default :
				require_once 'Db/Statement/Sqlsrv/Exception.php';
				throw new \Core\Db\Statement\Sqlsrv\Exception ( "Invalid fetch mode '$style' specified" );
				break;
		}
	...
	public function getColumnMeta($column) {
		...
		if (! $fields) {
			throw new \Core\Db\Statement\Sqlsrv\Exception ( 'Column metadata can not be fetched' );
		}
		
		if (! isset ( $fields [$column] )) {
			throw new \Core\Db\Statement\Sqlsrv\Exception ( 'Column index does not exist in statement' );
		}
