 ...
 * @code
 * <?php/**
 * @brief The fieldset class holds HTML-fieldset specific attributes and
 * methods.
 *
 * Class for the HTML fieldset element. Can be used to group other elments
 * together.
 ...
 * @endcode
 */
class Fieldset extends \Core\Htmlform\Abstracts\Container {
	// {{{ variables
	/**
	...
	public function __toString() {
		...
		return "<fieldset {$htmlAttributes}>" . "<legend>{$label}</legend>{$renderedElements}" . "</fieldset>\n";
	}
	// }}}
}
