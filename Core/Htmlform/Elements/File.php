 ...
 *      
 */
class File extends \Core\Htmlform\Elements\Text {
	...
	public function __toString() {
		...
		return "<p {$wrapperAttributes}>" . "<label>" . "<span class=\"label\">{$label}{$marker}</span>" . $maxInput . "<input name=\"{$this->name}[]\" type=\"{$this->type}\"{$inputAttributes}>" . $list . "</label>" . $errorMessage . $helpMessage . "</p>\n";
	}
	// }}}
	// {{{ htmlInputAttributes()
	/**
