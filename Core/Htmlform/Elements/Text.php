 ...
 * @endcode
 */
class Text extends \Core\Htmlform\Abstracts\Input {
	// {{{ variables
	/**
	...
	public function __toString() {
		...
		return "<p {$wrapperAttributes}>" . "<label>" . "<span class=\"label\">{$label}{$marker}</span>" . "<input name=\"{$this->name}\" type=\"{$this->type}\"{$inputAttributes} value=\"{$value}\">" . $list . "</label>" . $errorMessage . $helpMessage . "</p>\n";
	}
	// }}}
