 ...
 * @endcode
 */
class Textarea extends \Core\Htmlform\Elements\Text {
	// {{{ setDefaults()
	/**
	...
	public function __toString() {
		...
		return "<p {$wrapperAttributes}>" . "<label>" . "<span class=\"label\">{$label}{$marker}</span>" . "<textarea name=\"{$this->name}\"{$inputAttributes}{$rows}{$cols}>{$value}</textarea>" . "</label>" . $errorMessage . $helpMessage . "</p>\n";
	}
	// }}}
