...
class Curl {
	 ...
	 *
	 * @param
	 *        	string HTTP method to use (GET or POST)
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	integer Timeout delay in seconds
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	string File location of cookiejar
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	array All the parameters for GET or POST
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	integer Maximum number of redirects
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	boolean Whether to use cURL or not
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	boolean Whether to use cookies or not
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	boolean Whether to save persistent cookies or not
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	boolean Whether to follow HTTP redirects or not
	 * @return void
	 */
	...
	public function execute($target = '', $referrer = '', $method = '', $data = array()) {
		...
		if (is_array ( $this->params ) && count ( $this->params ) > 0) {
			...
			// Convert data array into a query string (ie
			// animal=dog&sport=baseball)
			
			$this->trimParams($this->params, $tempString);
		...
		if ($this->useCurl) {
			...
			if (in_array($this->status, array(302,301)) && $this->redirect == TRUE) {
	 ...
	 * @param
	 *        	string Cookie security (0 = non-secure, 1 = secure)
	 * @return void
	 * @access private
	 */
	...
	private function trimParams($params, &$output)
	{
		if(!is_array($params))
			return;
