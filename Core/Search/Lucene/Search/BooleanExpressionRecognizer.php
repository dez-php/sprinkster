...
class BooleanExpressionRecognizer extends \Core\Search\Lucene\FSM {
	/**
	...
	public function __construct() {
		...
		$emptyOperatorAction = new \Core\Search\Lucene\FSMAction ( $this, 'emptyOperatorAction' );
		$emptyNotOperatorAction = new \Core\Search\Lucene\FSMAction ( $this, 'emptyNotOperatorAction' );
		...
		$notOperatorAction = new \Core\Search\Lucene\FSMAction ( $this, 'notOperatorAction' );
		$orOperatorAction = new \Core\Search\Lucene\FSMAction ( $this, 'orOperatorAction' );
		$literalAction = new \Core\Search\Lucene\FSMAction ( $this, 'literalAction' );
	...
	public function finishExpression() {
		if ($this->getState () != self::ST_LITERAL) {
			throw new \Core\Search\Lucene\Exception ( 'Literal expected.' );
		}
