		...
		switch ($tokenCategory) {
			...
			case self::TC_SYNTAX_ELEMENT :
				switch ($tokenText) {
					...
					default :
						throw new \Core\Search\Lucene\Exception ( 'Unrecognized query syntax lexeme: \'' . $tokenText . '\'' );
				}
				break;
			...
			default :
				throw new \Core\Search\Lucene\Exception ( 'Unrecognized lexeme type: \'' . $tokenCategory . '\'' );
		}
	}
}
