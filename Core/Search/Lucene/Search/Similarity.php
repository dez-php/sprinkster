...
abstract class Similarity {
	 ...
	 *
	 * @var \Core\Search\Lucene\Search\Similarity
	 */
	 ...
	 * code.
	 *
	 * @param \Core\Search\Lucene\Search\Similarity $similarity        	
	 */
	public static function setDefault(\Core\Search\Lucene\Search\Similarity $similarity) {
	...
	public static function getDefault() {
		if (! self::$_defaultImpl instanceof \Core\Search\Lucene\Search\Similarity) {
			self::$_defaultImpl = new \Core\Search\Lucene\Search\Similarity\DefaultSimilarity ();
		}
	 ...
	 */
	public function idf($input,\Core\Search\Lucene\InterfaceLucene $reader) {
		if (! is_array ( $input )) {
