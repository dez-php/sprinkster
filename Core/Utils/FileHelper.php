...
class FileHelper
{
	 ...
	 * @since 1.1.14
	 */
	public static function removeDirectory($directory, $deleteRoot = true)
	{
		...
		if($deleteRoot && is_dir($directory)) {
			rmdir($directory);
		}
	}
	...
	{
		static $extensions=null,$customExtensions=array();
		if($magicFile===null && $extensions===null)
			$extensions=\Core\File\Ext::getAll();
