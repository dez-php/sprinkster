...
class DataColumn extends \Core\Web\Grid\GridColumn {
	...
	public function init()
	{
		...
		if($this->name===null && $this->value===null)
			throw new \Core\Exception('Either "name" or "value" must be specified for \FM\Fmx\Widgets\Grid\DataColumn.');
	}
	...
	protected function renderHeaderCellContent()
	{
		if($this->grid->enableSorting && $this->sortable && $this->name!==null) {
			echo $this->getSort()->link($this->name,$this->header,array('class'=>'sort-link'));
	 ...
	 */
	public function getSort($className='\Core\Web\Sort')
	{
		if($this->_sort===null)
		{
