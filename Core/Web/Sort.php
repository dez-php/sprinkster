...
class Sort extends \Core\Base\Action
{
	/**
	 * Sort ascending
	 * @since 1.1.10
	...
	public function link($attribute,$label=null,$htmlOptions=array())
	{
		...
		$url=$this->createUrl(\Core\Http\Request::getInstance()->getModule(),$directions);
	...
	{ 
		...
		$uri = new \Core\Web\Uri\Manager();
		$uri->showScriptName = false;
		return $uri->createUrl($this->route,$params);
	}
	...
	{ 
		if($this->attributes!==array()) {
			...
			return \Core\Camel::toCamelCase($attribute, true, true);
			return false;
		}
	...
	{
		return \FM\Db\ActiveRecord::model($className);
	}
	...
	{
		return \Core\Html::link($label,$url,$htmlOptions);
	}
}