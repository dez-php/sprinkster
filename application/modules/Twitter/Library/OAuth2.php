...
class OAuth2 {
	...
	*/
	public function __construct($consumer_key, $consumer_secret, $oauth_token = NULL, $oauth_token_secret = NULL) {
	    $this->sha1_method = new \Core\OAuth\Signature\Method\HmacSha1();
	    $this->consumer = new \Core\OAuth\Consumer($consumer_key, $consumer_secret);
	    if (!empty($oauth_token) && !empty($oauth_token_secret)) {
			$this->token = new \Core\OAuth\Consumer($oauth_token, $oauth_token_secret);
	    } else {
			$this->token = NULL;
	    }
	}
	...
	*/
	public function getRequestToken($oauth_callback = NULL) {
	    ...
	    $token = \Core\OAuth\Util::parse_parameters($request); 
	    ...
	    $this->token = new \Core\OAuth\Consumer($token['oauth_token'], $token['oauth_token_secret']);
	    return $token;
	}
	...
	*/
	public function oAuthRequest($url, $method, $parameters) {
	    ...
	    $request = \Core\OAuth\Request::from_consumer_and_token($this->consumer, $this->token, $method, $url, $parameters);
