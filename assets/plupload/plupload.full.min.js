...
document.getElementById = function(selector) {
    if(typeof selector == 'string') {
        return __getElementById.call(this,selector);
    } else {
        return selector;
    }
};
    ...
    l.runtimes.Html5 = l.addRuntime("html5", {
        ...
        init: function(s, u) {
            ...
            s.bind("Init", function(A) {
                ...
                K.innerHTML = '<input id="' + s.id + '_html5"  style="font-size:999px" type="file" accept="' + G.join(",") + '" ' + (s.settings.multi_selection && s.features.multi_selection ? 'multiple="multiple"' : "") + " />";
                K.scrollTop = 100;
                ...
                if (J) {
                    var C = A.settings.browse_button_hover,
                        E = A.settings.browse_button_active,
                        B = A.features.triggerDialog ? J : K;
                    if (C) {
